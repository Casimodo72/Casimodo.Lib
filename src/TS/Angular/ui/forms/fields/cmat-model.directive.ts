...
import {
    IFormInputControlAdaper, FormInputModel, PickerModel, AnyDateTimeInputModel,
    PickerItemModel, TypeaheadStringInputModel
} from "@lib/models"
 ...
 */
export class CMatModel implements OnInit, AfterContentChecked, OnDestroy, IFormInputControlAdaper {
    ...
    ngOnInit() {
        ...
        // Date picker
        if (cmatModel instanceof AnyDateTimeInputModel) {
        ...
        if (cmatModel instanceof TypeaheadStringInputModel) {
            const textModel = cmatModel as TypeaheadStringInputModel
        ...
        // Value picker
        if (cmatModel instanceof PickerModel) {
            const pickerModel = cmatModel as PickerModel
