...
namespace NConsoler
{
    ...
    public sealed class Consolery
    {
        ...
        {
            Run(targetType, args, messenger, Notation.Windows);
        }
        /// <summary>
        /// Runs an appropriate Action method
        /// </summary>
        ...
        public static void Run(Type targetType, string[] args, IMessenger messenger, Notation notationType)
        {
            try
            {
        ...
        public static void Run(object target, string[] args, IMessenger messenger)
        {
            Run(target, args, messenger, Notation.Windows);
        }
        /// <summary>
        /// Runs an appropriate Action method
        /// </summary>
        ...
        /// <param name="messenger">Uses for writing messages instead of Console class methods</param>
        /// <param name="notationType">Switch for command line syntax. Windows: /param:value Linux: -param value</param>
        public static void Run(object target, string[] args, IMessenger messenger, Notation notationType)
        {
...
namespace NConsoler
{
    ...
    public static class StringToObject
    {
        ...
        private static DateTime ConvertToDateTime(string parameter)
        {
            ...
            int day = 0;// (int)ConvertValue(parts[0], typeof(int));
            int month = 0;// (int)ConvertValue(parts[1], typeof(int));
            int year = 0;// (int)ConvertValue(parts[2], typeof(int));
