...
namespace kmodo {
    ...
    interface MoFolderTreeEntity extends kendo.data.Node {
        Id: string;
        Name: string;
        ParentId: string;
        IsDeleted: boolean;
    ...
    class MoFolderTreeViewModel {
        ...
        createDataSource(items: MoFolderTreeEntity[]): kendo.data.HierarchicalDataSource {
            return kmodo.createMoTreeViewDataSource(items);
        }
            ...
            return new Promise(function (resolve, reject) {
                ...
                cmodo.oDataQuery(query)
                    .then(function (rawItems) {
                        ...
                        self._items.forEach(function (x: any) {
    ...
    export interface MoFileExplorerOptions {
        $area: JQuery;
    ...
    export class MoFileExplorerViewModel {
        ...
        setOwnerValues(ownerKind: string, values): void {
        ...
        saveExistingFilesToFolder(folderId, fileInfos): void {
            var self = this;
    ...
    function _saveTreeViewState(vm, treeview: kendo.ui.TreeView): void {
        ...
        treeview.wrapper.find(".k-item").each((index, elem) => {
