...
namespace kmodo {
    ...
    export function showFileDownloadDialog(info, $context: JQuery): void {
    ...
    export function executeDialogAction($obsolete, title, url, dialogId, options, windowOptions, callback): void {

        var args = new cmodo.DialogArgs(dialogId, options.value || null);
