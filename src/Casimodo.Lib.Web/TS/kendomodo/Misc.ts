...
namespace kmodo {
    ...
    export function enableContextMenuItems(menu: kendo.ui.Menu, names: string[], enabled: boolean): void {
    ...
    function getContextMenuItems(menu: kendo.ui.Menu, names: string | string[]): JQuery {
