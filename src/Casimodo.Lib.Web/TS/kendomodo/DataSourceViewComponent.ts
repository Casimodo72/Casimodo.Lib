...
/// <reference path="../casimodo/ComponentRegistry.ts" />
/// <reference path="../casimodo/Data.ts" />
...
namespace kmodo {
    ...
    export abstract class DataSourceViewComponent extends ViewComponent {
        ...
        applyFilter(filters?: Array<any> | undefined): Promise<void> {
        ...
        getCurrent(): any | null {
            return this.scope.get("item") || null;
        }
        ...
        createDataModel(): any {
            ...
            return this._options.dataModel({ sender: this });
        }
