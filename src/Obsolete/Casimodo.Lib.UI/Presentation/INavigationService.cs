...
namespace Casimodo.Lib.Presentation.Navigation
{
    ...
    public class AppNode : ObservableObject
    {
        ...
        public string DisplayName
        {
            ...
            set { SetProperty(DisplayNameProperty, ref _displayName, value); }
        }
        string _displayName;
        public static readonly ObservablePropertyMetadata DisplayNameProperty = ObservablePropertyMetadata.Create("DisplayName");

        public bool HasChildren
        {
            get { return _hasChildren; }
            private set { SetValueTypeProperty(HasChildrenProperty, ref _hasChildren, value); }
        }
        bool _hasChildren;
        public static readonly ObservablePropertyMetadata HasChildrenProperty = ObservablePropertyMetadata.Create("HasChildren");
