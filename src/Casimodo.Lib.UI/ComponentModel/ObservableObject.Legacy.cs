...
namespace Casimodo.Lib.ComponentModel
{
    ...
    {
        protected void RaisePropertyChanged(ObservablePropertyMetadata args)
        {
            ...
            VerifyProperty(args.Name);
            OnPropertyChanged(args.Name);
            RaisePropertyChangedCore(args.Name);
        }
             ...
             where T : class
        {
            ...
            oldValue = newValue;
            RaisePropertyChanged(propMetadata.ChangedArgs.PropertyName);
            return true;
        }
