...
namespace Casimodo.Lib.Presentation
{
    ...
    public abstract class WizardTransition : ObservableObject
    {
        ...
        public bool IsEnabled
        {
            ...
            set { SetValueTypeProperty(IsEnabledProperty, ref _isEnabled, value); }
        }
        bool _isEnabled;
        public static readonly ObservablePropertyMetadata IsEnabledProperty = ObservablePropertyMetadata.Create("IsEnabled");
