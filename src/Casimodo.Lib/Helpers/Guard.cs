...
namespace Casimodo.Lib
{
    ...
    {
        public static void ArgNotNull([NotNull] object? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            if (arg == null) throw new ArgumentNullException(name);
        }

        public static void ArgNotEmpty([NotNull] int? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            if (arg == null) throw new ArgumentNullException(name);
        }

        public static void ArgNotEmpty<T>([NotNull] T[]? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            ArgNotNull(arg, name);
            if (arg.Length == 0)
        ...
        public static void ArgNotEmpty([NotNull] DateTimeOffset? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            ArgNotNull(arg, name);
        ...
        public static void ArgNotNone<T>([NotNull] T? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
        ...
        public static void ArgNotEmpty([NotNull] Guid? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            if (arg == null || arg == Guid.Empty)
                throw new ArgumentException("The given GUID must not be null or empty.", name);
        }

        public static void ArgNotNull([NotNull] Guid? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            if (arg == null || arg == Guid.Empty)
                throw new ArgumentException("The given GUID must not be null or empty.", name);
        }

        public static void ArgNotNullOrWhitespace([NotNull] string? arg, [CallerArgumentExpression(nameof(arg))] string? name = null)
        {
            if (arg == null)
        ...
        public static void ArgOneNotNull(object? arg1, object? arg2,
            [CallerArgumentExpression(nameof(arg1))] string? name1 = null,
            [CallerArgumentExpression(nameof(arg2))] string? name2 = null)
        {
